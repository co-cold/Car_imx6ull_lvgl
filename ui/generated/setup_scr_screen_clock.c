...
void setup_scr_screen_clock(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_clock_cont_clock, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_clock_label_1 = lv_label_create(ui->screen_clock_cont_clock);
    lv_label_set_text(ui->screen_clock_label_1, "测试");
    lv_label_set_long_mode(ui->screen_clock_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_clock_label_1, 350, 223);
    lv_obj_set_size(ui->screen_clock_label_1, 100, 32);
    ...
    lv_obj_set_style_text_color(ui->screen_clock_label_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_clock_label_1, &lv_font_SourceHanSerifSC_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
